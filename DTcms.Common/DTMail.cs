...
namespace DTcms.Common
{
    public class DTMail
    {
        ...
        public static void sendMail(int port,string smtpserver, int enablessl, string userName, string pwd, string nickName, string strfrom, string strto, string subj, string bodys)
        {
