...
namespace DTcms.Common
{
    ...
    {
        // General
        public string _MODULUS = "";
        public string _NONCE = "0CoJUm6Qyw8W8jud";
        public string _PUBKEY = "010001";
        public string _VI = "0102030405060708";
        public string _USERAGENT = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36";
        public string _COOKIE = "os=pc;osver=Microsoft-Windows-10-Professional-build-16299.125-64bit;appver=2.0.3.131777;channel=netease;__remember_me=true";
        public string _REFERER = "http://music.163.com/";
        // use keygen in c#
        public string _secretKey;
        public string _encSecKey;
        ...
        // encrypt mod
        public string RSAEncode(string text)
        {
        ...
        public BigInteger BCHexDec(string hex)
        {
        ...
        public string AESEncode(string secretData, string secret = "TA3YiYCfY2dDJQgg")
        {
            byte[] encrypted;
        ...
        // fake curl
        public string CURL(string url, Dictionary<string, string> parms, string method = "POST")
        {
            string result;
