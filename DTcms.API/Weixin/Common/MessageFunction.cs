...
namespace DTcms.API.Weixin.Common
{
    ...
    {
        Model.siteconfig sysConfig = new BLL.siteconfig().loadConfig(); //站点配置
        ...
        public IResponseMessageBase GetResponseMessageNews(RequestMessageText requestMessage, int ruleId, int accountId)
        {
            ...
            IList<Model.weixin_request_content> twList = new BLL.weixin_request_content().GetModelList(10, "rule_id=" + ruleId, string.Empty, string.Empty);
