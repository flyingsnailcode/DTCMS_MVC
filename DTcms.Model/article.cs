...
namespace DTcms.Model
{
    ...
    public partial class article
    {
        ...
        /// 图片相册
        /// </summary>
        public List<article_albums> albums { get; set; }

        [ResultColumn]
        /// <summary>
        /// 内容附件
        /// </summary>
        public List<article_attach> attach { get; set; }

        [ResultColumn]
        /// <summary>
        /// 扩展参数
        /// </summary>
        public List<article_attribute> attribute { get; set; }

        [ResultColumn]
        /// <summary>
        /// 商品价格
        /// </summary>
        public List<article_goods> goods { get; set; }
        
        [ResultColumn]
        /// <summary>
        /// 商品规格
        /// </summary>
        public List<article_goods_spec> specs { get; set; }
        #endregion
    }
}